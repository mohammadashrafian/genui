      ...
      <div className="min-w-0 flex-1">
        ...
        <section id="prerequisites" className="mb-12">
          ...
          <ul className="space-y-2 text-text-secondary">
            <li className="flex items-center gap-2">
              ...
              <span>
                <strong className="text-text-primary">Node.js 18+</strong> (LTS recommended)
              </span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent">--</span>
              <span>
                <strong className="text-text-primary">React 18+</strong> (or React 19)
              </span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent">--</span>
              <span>
                A package manager: <InlineCode>npm</InlineCode>, <InlineCode>pnpm</InlineCode>, or{' '}
        ...
        <section id="installation" className="mb-12">
          ...
          <p className="text-text-secondary mb-4">
            GenUIKit is split into focused packages. Install the core library and the React
            bindings:
          </p>
          ...
          <div className="space-y-3">
            <div>
              ...
              <CodeBlock language="bash" code="npm install @genuikit/core @genuikit/react zod" />
            </div>
            <div>
              <p className="text-xs font-mono text-text-secondary mb-1">pnpm</p>
              <CodeBlock language="bash" code="pnpm add @genuikit/core @genuikit/react zod" />
            </div>
            <div>
              <p className="text-xs font-mono text-text-secondary mb-1">yarn</p>
              <CodeBlock language="bash" code="yarn add @genuikit/core @genuikit/react zod" />
            </div>
          </div>

          <p className="mt-4 text-text-secondary">
            If you plan to use a pre-built adapter (shadcn/ui, Tailwind, MUI), also install the
            adapters package:
          </p>
        ...
        <section id="cli" className="mb-12">
          ...
          <p className="text-text-secondary mb-4">
            The fastest way to scaffold a new project is with the GenUIKit CLI. It generates a
            registry file, installs dependencies, and sets up your preferred adapter:
          </p>
          <CodeBlock language="bash" code="npx @genuikit/cli init" />
          <p className="text-text-secondary mt-4">
            The CLI will ask you to pick an adapter (shadcn/ui, Tailwind, or MUI), then create a{' '}
            <InlineCode>genui.registry.ts</InlineCode> file with all 30 components pre-configured.
          </p>
        ...
        <section id="quick-start" className="mb-12">
          ...
          <p className="text-text-secondary mb-4">
            Here is the minimal setup to render an LLM-produced component. This three-step process
            works the same whether you use an adapter or build your own schemas.
          </p>
          ...
          <p className="text-text-secondary mb-3">
            Create a Zod schema describing the props your component expects. The LLM will produce
...
export type WeatherCardProps = z.infer<typeof weatherCardSchema>;`}
          ...
          <p className="text-text-secondary mb-3">
            Register your component with its schema. The registry maps component names to schemas
            and implementations.
          </p>
          <CodeBlock
            language="typescript"
...
registry.register('WeatherCard', weatherCardSchema, WeatherCard);`}
          ...
          <p className="text-text-secondary mb-3">
            Use the <InlineCode>useGenerativeUI</InlineCode> hook to resolve LLM output into a
    ...
    <div className="rounded-xl border p-4 shadow-sm">
      ...
      {humidity !== undefined && (
        ...
        <section id="full-example" className="mb-12">
          ...
          <p className="text-text-secondary mb-4">
            This complete example shows how to connect an LLM API response to GenUIKit rendering. It
            uses the <InlineCode>GenerativeUI</InlineCode> declarative component.
          </p>
          <CodeBlock
            language="tsx"
            filename="app.tsx"
        ...
        <section id="whats-next">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-1 text-sm text-text-secondary">
                Use pre-built shadcn/ui, Tailwind, or MUI registries.
              </p>
            </Link>
            <Link
              href="/docs/security"
