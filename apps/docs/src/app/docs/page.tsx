...
export default function DocsPage() {
  return (
    <div>
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-text-primary mb-4">GenUIKit Documentation</h1>
        <p className="text-lg text-text-secondary max-w-2xl">
          Type-safe, schema-validated UI rendering from LLM outputs. GenUIKit gives you a registry
          of Zod-validated components that your AI can render safely, with automatic error
          correction and streaming support.
        </p>
      </div>
